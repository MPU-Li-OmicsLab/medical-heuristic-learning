...
from hl.agent.continuous_prompts import get_continuous_v0_generation_prompt
...
def generate_v0_task(
    *,
    ...
    prompt = get_continuous_v0_generation_prompt(
        univariate_summary=univariate_summary,
        knowledge_table=knowledge_table,
        metric_desc=metric_desc,
        task_description=run_cfg.task_description,
        dropped_cols=drift.dropped_cols,
        added_cols=drift.added_cols,
        renamed_cols=drift.renamed_cols,
